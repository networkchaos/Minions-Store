...
<head>
  ...
  <title>Minions Store- Landing Page</title>
  <?php 
    require "header.php"; 
...
<body>
  <div class="slider" style="width: 60%; margin: auto;">
    <ul class="slides">
      <li>
        <img src="./static/images/download1.jpg"> 
        <div class="caption center-align">
          <h3></h3>
          <h5 class="light grey-text text-lighten-3 bold page-title">From Laptops to Gadgets, we got u covered! HOMIE!!</h5>
        </div>
      </li>
      <li>
        <img src="./static/images/download2.jpg"> 
        <div class="caption center-align">
          <h3 class="bold page-title">At Minions Store</h3>
          <h5 class="bold page-title">From Laptops to Techy Gadgets, we got u covered! HOMIE!!</h5>
        </div>
      </li>
      <!--
      <li>
        <img src="static/images/download3.jpg"> 
      </li>
...
-->
  ...
  <div class="container" style="margin-top: 100px">
    <div class="row">
      <div class="row" style="margin-bottom: -20px">
        <h4 class="underline white-text bold center">THE DARK STORE!!! 😱</h4>
      </div>
        ...
        <div class="col hoverable">
          <a href="product_catalogue.php?category=0" class="hoverable">
            <div class="selectable-card hoverable" style="width: 300px; margin: 50px;">
              ...
              <h5 class="white-text center bold hoverable">CPUs</h5>
            </div>
          </a>
        </div>
        ...
        <div class="col">
          <a href="product_catalogue.php?category=1">
            <div class="selectable-card" style="width: 300px; margin: 50px;">
              ...
              <h5 class="white-text center bold" style="margin-top : 120px">ELECTRONICS</h5>
            </div>
          </a>
        </div>
        ...
        <div class="col">
          <a href="product_catalogue.php?category=2">
            <div class="selectable-card" style="width: 300px; margin: 50px;">
              ...
              <h5 class="white-text center bold">TECHY GADGETS</h5>
            </div>
          </a>
        </div>
      </div>
  ...
  <div class="section" style="margin-top: 100px;">
    <div class="wide-container">
      <h3 class="white-text center">WE JUST WANT YOUR MONEY NOTHING MORE😊</h3>
      <h5 class="white-text center">
        At <b class="orange-text">Minions Store</b>, We are a team of serious gamers and overclockers with a passion towards customized and fast PCs.
      </h5>
    </div>
  </div>
  ...
  <div class="grid" style="margin-top: 20px; margin-bottom: 100px">
    ...
    <div class="grid">
      <h1 class="count red-text text-darken-4 bold center">42</h1>
      <h5 class="white-text center">Counties Covered</h5>
    </div>
    <div class="grid">
  ...
  <h3 class="white-text center">Minions Store - Laptops Unvieling 😱</h3>
  ...
  <div style="display:none">
    <video style="display:block; margin: 0 auto;" class="responsive-video" width="1280" height="720" autoplay="autoplay" controls unmuted>
      <source src="static/FROSTY.mp4" type="video/mp4">
    </video>
  </div>
<!----
