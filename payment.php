...
<head>
  ...
  <title>Minions Store - Payment</title>
  <?php 
    include "header.php"; 
...
<body>
  <div class="container">
    ...
    <div class="selectable-card grey darken-4" id="no-hover">
      ...
      <form class="row white-text" action="payment.php?order_id=<?php echo(isset($_GET["order_id"]) ? $_GET["order_id"] : ''); ?>&member_id=<?php echo(isset($_GET["member_id"]) ? $_GET["member_id"] : ''); ?>&view_order=1" method="POST" style="margin-left: 50px;">
        <div class="col s8">
          <div class="row">
