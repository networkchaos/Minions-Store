...
<head>
	...
	<title>Minions Store - Report</title>
	<?php 
	include "header.php";
...
<div class="container" style="margin-top:150px">
	...
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		...
		<h4 style="color:white">Total sales of last 7 days: Ksh<?php echo $data_tot = number_format((float)$data_tot, 2, '.', '');?></h4>
	...
	<div class="rounded-card-parent center" style="margin-bottom:20px">
		...
		?>
		<h4 style="color:white">Total sales of last 90 days: Ksh<?php echo $month_tot = number_format((float)$month_tot, 2, '.', '');?></h4>
	</div>
	<br><br><br>
