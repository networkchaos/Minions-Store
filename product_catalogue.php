...
<body>
  <head>
    ...
    <title>Minions Stores - Product Catalogue</title>
    <?php 
            ...
            <div class="section" style="margin-bottom: 100px;">
              <div class="col unglow">
                <ul id="filter_dropdown" class="dropdown-content black">
                  ...
                  <li><a class="cyan-text page-title" onclick="select_category(this)">CPUs</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">ELECTORNICS</a></li>
                  <li><a class="cyan-text page-title" onclick="select_category(this)">TECHY GADJECTS</a></li>
                </ul>
