          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($displayShipping === 0) $displayShipping = "<span class='underline'>Ksh$displayShipping</span>";
                else $displayShipping = "Ksh$displayShipping";

                if ($sumTotal >= 2000){
                  $shippingTotal = $sumTotal - 100;
                  $displayPVoucher = "<span class='underline'>-Ksk100</span> <span class='yellow-text'>(Promo voucher applied)</span>";
                }
                ...
                echo("<tr><th >Discount Voucher:</th><td >$displayPVoucher</td></tr>");
                echo("<tr><th>Sum Total:</th><td>Ksh$sumTotal</td></tr>");
